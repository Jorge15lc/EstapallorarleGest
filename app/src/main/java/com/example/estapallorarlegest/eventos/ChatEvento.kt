...
class ChatEvento : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var pojo_evento = intent.getParcelableExtra<Evento>("chat_evento")!!
        title = pojo_evento.nombre+" chat"
        ...
        db_ref.child("tienda").child("chat_eventos")
